...
app.get ('/autocomplete', (req, res) =>{
    ...
    const urlAutocomplete = 'https://api.tiingo.com/tiingo/utilities/search?query='+keyw+'&token=4ffcd6c74eea5dec298d98d746579a00f69ed180'
...
app.get ('/stockdetails', (req, res) =>{
    ...
    var keyw = req.query.keyword
    const urlStockDetails = 'https://api.tiingo.com/tiingo/daily/'+keyw+'?token=4ffcd6c74eea5dec298d98d746579a00f69ed180'
...
app.get ('/summary', (req, res) =>{
    ...
    var keyw = req.query.keyword
    const urlSummary = 'https://api.tiingo.com/iex?tickers='+keyw+'&token=4ffcd6c74eea5dec298d98d746579a00f69ed180';
    //const urlStockDetails = 'https://api.tiingo.com/tiingo/daily/AAPL?token=4ffcd6c74eea5dec298d98d746579a00f69ed180'
...
app.get ('/news', (req, res) =>{
    ...
    const urlNews = 'https://newsapi.org/v2/everything?apiKey=96be8b0edae344488a23ab9932ad9e4e='+keyw;
    var newsObject = []
    maxLength = 20;
...
app.get ('/charts', (req, res) =>{
    ...
    const urlCharts = 'https://api.tiingo.com/iex/AAPL/prices?startDate=2019-09-10&resampleFreq=4min&token=4ffcd6c74eea5dec298d98d746579a00f69ed180'
...
app.get ('/history', (req, res) =>{
    ...
    const urlCharts = 'https://api.tiingo.com/tiingo/daily/'+keyw+'/prices?startDate='+dater+'&token=4ffcd6c74eea5dec298d98d746579a00f69ed180'
    fetch (urlCharts).then((response) =>  {
        response.json().then ((data) => {
        var counter =0;
...
app.get ('/daily', (req, res) =>{
  ...
  // console.log ('startDate is '+ startDate);
   const urlCharts = 'https://api.tiingo.com/iex/'+keyw+'/prices?startDate='+startDate+'&resampleFreq=4min&token=4ffcd6c74eea5dec298d98d746579a00f69ed180'
    
    // 4ffcd6c74eea5dec298d98d746579a00f69ed180
    fetch (urlCharts).then((response) =>  {
        response.json().then ((data) => {   
                res.send (data);
        })
...
app.get ('/latest', (req, res) =>{
    ...
    const urlCharts = 'https://api.tiingo.com/iex?tickers=AAPL&token=4ffcd6c74eea5dec298d98d746579a00f69ed180'
    // 4ffcd6c74eea5dec298d98d746579a00f69ed180
