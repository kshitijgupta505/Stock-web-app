...
(params: Params) => {
  ...
  // change this
  this.http.get ('https://www.alphavantage.co/query?function=OVERVIEW&symbol=${this.ticker}&apikey=HE5IVHE8FKBSJY0E').subscribe ((dataobj) => {
...
this.innerSubscription =   this.http.get ('https://www.alphavantage.co/query?function=OVERVIEW&symbol=${this.ticker}&apikey=HE5IVHE8FKBSJY0E').subscribe ((dataobj) => {
  ...
  this.isLoading = false;
    ...
    this.chartSubscription = this.http.get('https://www.alphavantage.co/query?function=OVERVIEW&symbol=${this.ticker}&apikey=HE5IVHE8FKBSJY0E').subscribe((data) =>{
    ...
    this.handleUpdate();
      ...
      this.http.get ('http://localhost:3000/history?keyword='+this.ticker+'&startDate='+this.marketClosed).subscribe ((data) => {
...
getNewsData()
{
  const url = 'https://www.alphavantage.co/query?function=NEWS_SENTIMENT&tickers=${this.ticker}&apikey=HE5IVHE8FKBSJY0E';
